                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td>' . $row["Work"] . '</td>';
                                echo '<td><a style="text-decoration: none" href="update-admin.php?id=' . $row["idad"] . '" ><i class="bi bi-pencil-square"></i>Sửa</a></td>';
                                echo '<td><a style="text-decoration: none" href="delete-admin.php?id=' . $row["idad"] . '" ><i class="bi bi-trash-fill"></i>Xóa</a></td>';
                                echo '</tr>';
                            }
                        } else {
                            echo "0 results";
